...
Le module Account Purchase pour OpenERP 6.0.2 vous permet gérer plus facilement votre comptabilité concernant les
...
de déclarer un achat très simplement. Les journaux seront correctement rempli, mais devront être validés à la main.
